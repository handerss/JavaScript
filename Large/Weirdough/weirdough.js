...
function getReceipt() {
	...
	getMeat(runningTotal,text1,text2); // Blanket variable
};	

// This is the running total. The items are by default $1, but the first one is free. 
// So total from each array minus $1 to get the total from that array
// Then the running total is summarized at the end
